...
class ClassifierHead(nn.Module):
    def __init__(self,
        ...
        sentence_embedding_size = config["model"]["sentence_embedding_size"]   # Size of sentence embeddings
        n_classes_cls           = config["model"]["n_classes_cls"]             # Number of Classes to Classify
